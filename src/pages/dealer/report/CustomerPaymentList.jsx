...
import { getCustomerPaymentList } from '../../../middleware/serviceReport/serviceReport';
...
const CustomerPaymentList = () => {
  ...
  const { customerPaymentList, customerPaymentListLoading } = useSelector((state) => state?.serviceReport);
