...
const ProductCategoryList = () => {
    ...
    const getProductCategoryData = async () => {
        try {
            setLoading(true)
            const response = await get(`/admin/get-product-category`);
    ...
    const handleDelete = async (elem) => {
        ...
        if (confirmResult.isConfirmed) {
            try {
                const response = await deleteById(`/admin/delete-product-category`, elem._id);
                if (response.success) {
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-sm-8">
                                <div className="d-flex align-items-center flex-wrap row-gap-2 justify-content-sm-end">
                                    ...
                                    <Link
                                        to={ADMIN_URLS.MANAGE_PRODUCT_CAT}
                                            ...
                                            <tr key={elem?._id}>
                                                ...
                                                <td style={{ textAlign: "end" }}>
                                                    <div className="dropdown table-action">
                                                        ...
                                                        >
                                                            <Link className="dropdown-item" to={ADMIN_URLS.MANAGE_PRODUCT_CAT} state={elem}>
