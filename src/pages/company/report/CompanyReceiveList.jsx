...
import { getCompanyReceiveList } from '../../../middleware/companyUser/comSerReport/comSerReport';
...
const CompanyReceiveList = () => {
  ...
  const { companyReceiveList, companyReceiveListLoading } = useSelector((state) => state?.comSerReport);
