...
const SupplyType = () => {
  ...
  const commentsData = useMemo(() => {
    let computedComments = comSupplyTypeList || [];
    if (search) {
  ...
  }, [currentPage, search, limit, comSupplyTypeList]);

  return (
    <div className="row">
      <div className="col-md-12">
        <PageHeader
          name={"Supply Type List"}
          count={comSupplyTypeList?.length}
        ...
        {comSupplyTypeListError && (
          <div className="alert alert-danger text-center" role="alert">
            {comSupplyTypeListError || "Something went wrong while fetching data."}
          </div>
        )}

        {!comSupplyTypeListLoading && !comSupplyTypeListError && (
          <div className="card">
              ...
              <div className="row align-items-center">
                ...
                <div className="col-sm-8">
                  <div className="d-flex align-items-center flex-wrap row-gap-2 justify-content-sm-end">
                    ...
                    <Link to={COMPANY_URLS.MANAGE_SUPPLY_TYPE} className="btn btn-primary">
                      ...
                      <tr key={elem?._id}>
                        ...
                        <td style={{ textAlign: "end" }}>
                          <div className="dropdown table-action">
                            ...
                            >
                              <Link className="dropdown-item" to={COMPANY_URLS.MANAGE_SUPPLY_TYPE} state={elem}>
