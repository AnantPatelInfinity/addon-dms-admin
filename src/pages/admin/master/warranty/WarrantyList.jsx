...
const WarrantyList = () => {
    ...
    const getWarrrantyData = async () => {
        try {
            setLoading(true)
            const response = await get(`/admin/get-warranty`);
    ...
    const handleDelete = async (elem) => {
        ...
        if (confirmResult.isConfirmed) {
            try {
                const response = await deleteById(`/admin/delete-warranty`, elem._id);
                if (response.success) {
                                            ...
                                            <tr key={elem?._id}>
                                                ...
                                                <td style={{ textAlign: "end" }}>
                                                    <div className="dropdown table-action">
                                                        ...
                                                        >
                                                            <Link className="dropdown-item" to={ADMIN_URLS.MANAGE_WARRANTY} state={elem}>
