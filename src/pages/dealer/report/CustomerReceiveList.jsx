...
import { getCustomerReceiveList } from '../../../middleware/serviceReport/serviceReport';
...
const CustomerReceiveList = () => {
    ...
    const { customerReceiveList, customerReceiveListLoading } = useSelector((state) => state?.serviceReport);
