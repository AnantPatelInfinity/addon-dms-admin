...
import { downloadInstallationReport, 
  getOneInstallation, resetDownloadInstallation } from '../../../middleware/customerUser/customerInstallation/installation';
...
const ViewInstallation = () => {
    ...
    useEffect(() => {
        if (!data) {
            navigate(CUSTOMER_URLS.INSTALLATION_LIST);
        }
    }, [data])
    ...
    const handleDownload = (id) => {
        const formData = new URLSearchParams();
        formData.append("isDealer", false);
        dispatch(downloadInstallationReport(formData, id))
    }
        ...
        <div className="container-fluid py-4">
            <div className="row">
                <div className="col-12">
                    <BreadCrumbs
                        crumbs={[
                            { label: "Installation List", to: CUSTOMER_URLS.INSTALLATION_LIST },
                    ...
                    <div className="card shadow-sm border-0">
                        ...
                        <div className="card-body">
                            <InstallSection isDealer={false} companyInstallationOneList={installationOne} openImageModal={openImageModal} />
                        </div>
                        <div className="card-footer bg-white border-top">
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <button
                                    ...
                                    onClick={() => navigate(CUSTOMER_URLS.INSTALLATION_LIST)}
                                >
