...
const UnitList = () => {
  ...
  const getUnitData = async () => {
    try {
      setLoading(true)
      const response = await get(`/admin/get-unit`);
  ...
  const handleDelete = async (elem) => {
    ...
    if (confirmResult.isConfirmed) {
      try {
        const response = await deleteById(`/admin/delete-unit`, elem._id);
        if (response.success) {
                      ...
                      <tr key={elem?._id}>
                        ...
                        <td style={{ textAlign: "end" }}>
                          <div className="dropdown table-action">
                            ...
                            >
                              <Link className="dropdown-item" to={ADMIN_URLS.PRO_MANAGE_UNIT} state={elem}>
