    ...
    return (
        <>
            <div className="container-fluid">
                    ...
                    <div className="card-body p-4">
                        <div className="row g-3">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="form-floating">
                                        {/* <select
                                            ...
                                            onChange={handleChange}
                                        // disabled={!filterSerialNo?.length}
                                        >
                                            <option value="">Select Serial Number</option>
                                            {filterSerialNo?.map(serial => (
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="form-floating">
                                    <select
                                        className={`form-control form-select ${errors.requestBy ? "is-invalid" : ""}`}
                                        name="requestBy"
                            ...
                            <div className="col-12">
                                <div className="form-floating">
                                    ...
                                    />
                                    <label>Nature Of Complaint <span className="text-danger">*</span></label>
                ...
                <ServiceDetails service={service} filterSerialNo={filterSerialNo} />
            </div>
        </>
    )
}
