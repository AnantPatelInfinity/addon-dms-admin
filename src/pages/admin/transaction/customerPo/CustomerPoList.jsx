...
const CustomerPoList = () => {
  ...
  const getPoData = async () => {
    try {
      ...
      const url = `/admin/get-customer-po`;
  ...
  const handleDownload = async (poId) => {
    try {
      const response = await get(`/admin/download-customer-po/${poId}`);
  ...
  return (
    <div className="row">
      <div className="col-md-12">
        <PageHeader name={"Customer PO List"} count={entity?.length} handleRefresh={handleRefresh} />
                        ...
                        <td style={{ textAlign: "end" }}>
                          <div className="dropdown table-action">
                            ...
                            <div className="dropdown-menu dropdown-menu-right">
                              <Link className="dropdown-item" to={`${ADMIN_URLS.VIEW_CUSTOMER_PO}/${elem?._id}`}>
