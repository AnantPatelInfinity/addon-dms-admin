import { customerInstallService } from "../../../services/customer/installation";
...
} from "../../../slices/customer/installation.slice";


export const getAllInstallation = (payload) => {
    return (dispatch) => {
        dispatch(installationListRequest());
        customerInstallService.getCuInstall(payload)
            .then((response) => {
...
export const getOneInstallation = (payload, id) => {
    return (dispatch) => {
        ...
        customerInstallService.getCuInstallOne(payload, id)
            .then((response) => {
                const { data, success, message } = response?.data;
                if (success === true) {
...
export const addInstallation = (payload) => {
    return (dispatch) => {
        ...
        customerInstallService.addCuInstall(payload)
            .then((response) => {
                const { data, success, message } = response?.data;
                if (success === true) {
...
export const editInstallation = (payload) => {
    return (dispatch) => {
        ...
        customerInstallService.editCuInstall(payload)
            .then((response) => {
                const { data, success, message } = response?.data;
                if (success === true) {
...
export const downloadInstallationReport = (payload, id) => {
    return (dispatch) => {
        dispatch(downloadInstallationRequest());
        customerInstallService.downloadInstallation(payload, id)
            .then((response) => {
                const { data, success, message } = response?.data;
                if (success === true) {
