...
const ManageProductCategory = () => {
    ...
    const handleSubmit = async (addMore = false) => {
        ...
        try {
            ...
            const url = data?._id ? `/admin/manage-product-category/${data._id}` : "/admin/manage-product-category";
            ...
            if (success) {
                if (addMore) {
                    ...
                    navigate(ADMIN_URLS.PRODUCT_CAT);
                }
    ...
    return (
        <div className="row">
            <div className="col-md-12">
                <BreadCrumbs
                    crumbs={[
                        { label: "Product Category List", to: ADMIN_URLS.PRODUCT_CAT },
