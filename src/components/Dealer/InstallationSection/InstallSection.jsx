...
const InstallSection = ({ installation, errors, handleChange, data }) => {
    ...
    const allSerialNumbers = poSerialNo || [];
    const installedSerialNumbers = poInstallSerialNo || [];
                        ...
                        <div className="form-floating mb-3">
                            ...
                            >
                                ...
                                {serialNumbersForDropdown?.map((e) =>
                                    <option value={e?._id} key={e?._id}>{e?.companySerialNo}</option>
                                )}
                            </select> */}
                            <Dropdown
                                name="serialNoId"
