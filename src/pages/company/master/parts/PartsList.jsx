...
const PartsList = () => {
  ...
  const commentsData = useMemo(() => {
    let computedComments = companyPartsList || [];
    if (search) {
  ...
  }, [currentPage, search, limit, companyPartsList]);
      ...
      <div className="col-md-12">
        ...
        {companyPartsListError && (
          <div className="alert alert-danger text-center" role="alert">
            {companyPartsListError || "Something went wrong while fetching data."}
          </div>
        )}

        {!companyPartsListLoading && !companyPartsListError && (
          <div className="card">
              ...
              <div className="row align-items-center">
                ...
                <div className="col-sm-8">
                  <div className="d-flex align-items-center flex-wrap row-gap-2 justify-content-sm-end">
                    ...
                    <Link to={COMPANY_URLS.MANAGE_PART} className="btn btn-primary">
                      ...
                      <tr key={elem?._id}>
                        ...
                        <td style={{ textAlign: "end" }}>
                          <div className="dropdown table-action">
                            ...
                            >
                              <Link className="dropdown-item" to={COMPANY_URLS.MANAGE_PART} state={elem}>
