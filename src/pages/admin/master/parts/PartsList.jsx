...
const PartsList = () => {
  ...
  const getPartsData = async () => {
    try {
      setLoading(true)
      const response = await get(`/admin/get-parts?firmId=${adminStorage.DX_AD_FIRM}`);
  ...
  const handleDelete = async (elem) => {
    ...
    if (confirmResult.isConfirmed) {
      try {
        const response = await deleteById(`/admin/delete-parts`, elem._id);
        if (response.success) {
                      ...
                      <tr key={elem?._id}>
                        ...
                        <td style={{ textAlign: "end" }}>
                          <div className="dropdown table-action">
                            ...
                            >
                              <Link className="dropdown-item" to={ADMIN_URLS.PRO_MANAGE_PART} state={elem}>
