...
import { CUSTOMER_INSTALL } from "../../helpers/slice.name";

export const customerInstallationSlice = createSlice({
...
} = customerInstallationSlice.actions;

export default customerInstallationSlice.reducer;