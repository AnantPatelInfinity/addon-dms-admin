...
const UnitList = () => {
  ...
  const commentsData = useMemo(() => {
    let computedComments = comUnitList || [];
    if (search) {
  ...
  }, [currentPage, search, limit, comUnitList]);
      ...
      <div className="col-md-12">
        ...
        {comUnitListError && (
          <div className="alert alert-danger text-center" role="alert">
            {comUnitListError || "Something went wrong while fetching data."}
          </div>
        )}

        {!comUnitListLoading && !comUnitListError && (
          <div className="card">
              ...
              <div className="row align-items-center">
                ...
                <div className="col-sm-8">
                  <div className="d-flex align-items-center flex-wrap row-gap-2 justify-content-sm-end">
                    ...
                    <Link to={COMPANY_URLS.MANAGE_UNIT} className="btn btn-primary">
                      ...
                      <tr key={elem?._id}>
                        ...
                        <td style={{ textAlign: "end" }}>
                          <div className="dropdown table-action">
                            ...
                            >
                              <Link className="dropdown-item" to={COMPANY_URLS.MANAGE_UNIT} state={elem}>
